...
import com.github.behaim.domain.EmptyEnum;
...
public class EnumAdapterTest {
    ...
    public void testConvert_singleValueEnum() throws Exception {
        assertThat(SingleValueEnum.values().length).isEqualTo(1);
        ...
        verifyActualValue(SingleValueEnum.class, actualValue, SINGLE_VALUE);
    }
